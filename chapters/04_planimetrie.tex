...
\begin{pozn}
  ...
  \begin{itemize}
    \item \uv{ležet na} -- \textbf{relace incidence}: bod leží na přímce, přímka obsahuje bod: $A \in p$
    \item \uv{ležet mezi} -- \textbf{relace uspořádání}: bod leží mezi body: $X \mu AB$
  \end{itemize}
\end{pozn}
...
\begin{proof}
  \begin{figure}[h!]
    \centering
    \includegraphics[width=0.3\linewidth]{uhly.png}
  \end{figure}
\end{proof}
