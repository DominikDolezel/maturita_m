...
\begin{pozn}
  ...
  které považujeme za platné. Budeme pracovat v rovině $\mathbb E_2$ (\textbf{eukleidovský prostor dimenze 2}),
...
\begin{definition}\label{raddef}
    Nechť máme úhel $\sphericalangle AVB$. Úhlu $\sphericalangle AVB$ přiřaďme číslo $a\in \left<  0, 2\pi \right>$,
...
\begin{veta}
  Nechť je dán čtyřúhelník $ABCD$ se stranami $a,b,c,d$ a úhly $\alpha, \beta, \gamma, \delta.$ Pak platí, že
  \begin{itemize}
