...
\begin{veta}
    ...
    \begin{enumerate}[$i.$]
        \item $\mathcal D(f)= \mathbb R$, $\mathcal H(f)= \left<  -1,1 \right> $;
       	\item $f$ je lichá;
        \item $f$ je rostoucí v intervalu $\left<  -\frac{\pi}{2}+2k\pi, \frac{\pi}{2}+2k\pi \right> $ a klesající v $\left<  \frac{\pi}{2}+2k\pi, \frac{3\pi}{2}+2k\pi \right> $;
        \item $f$ je omezená;
    ...
    \begin{enumerate}[$i.$]
        \item $\mathcal D(f)= \mathbb R$, $\mathcal H(f)= \left<  -1,1 \right> $;
       	\item $f$ je sudá;
        \item $f$ je rostoucí v intervalu $\left<  \pi+2k\pi, 2\pi+2k\pi \right> $ a klesající v $\left<  0+2k\pi, \pi+2k\pi \right> $;
        \item $f$ je omezená;
