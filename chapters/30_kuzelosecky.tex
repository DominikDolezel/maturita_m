...
\begin{definition}
    ...
    \end{enumerate}
   Tyto tvary nazýváme \textbf{kanonickými rovnicemi kuželosečky}.
\end{definition}
...
\begin{definition}
    Bod $S$ je středem kuželosečky $k$ právě tehdy, když $\forall X\in k\colon \exists X^\prime\in k\colon  S$ je středem $XX^\prime.$
\end{definition}
