...
\begin{definition}\label{kolmeprimky}
    Přímky $p,q \subset \mathbb E_3$ se nazývají navzájem \textbf{kolmé} právě tehdy, když
...
\begin{definition}
    ...
    pokud $\exists S\colon\exists\mathscr U = \mathscr S_S(\mathscr U).$
\end{definition}
...
\begin{veta}
    Nechť $\mathscr S_\beta \circ \mathscr S_\alpha\colon \mathbb E_3 \to \mathbb E_3$ je
    složené zobrazení dvou rovin souměrných s rovinami $\alpha, \beta \subset \mathbb
    E_3$. Nechť $\alpha \parallel \beta$, pak $\forall X\in \mathbb E_3\colon \mathscr
