...
\begin{veta}[Kritérium rovnoběžnosti přímky a roviny]
    $\forall p \in \mathscr P, \forall \rho \subseteq \mathbb E_3\colon p \parallel \rho
    \iff \exists q\subseteq \rho\colon p\parallel q.$
\end{veta}
...
\begin{veta}\label{kolmostprimekposun}
    ...
    \subseteq \mathbb E_3\colon p^\prime \parallel p, q^\prime \parallel q \implies
