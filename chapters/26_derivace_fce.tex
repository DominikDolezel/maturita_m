...
\item $(\tg x)^\prime = \frac{1}{\cos^2 x}, x \in \mathbb R \smallsetminus \left \{ \frac{\pi}{2}+k\pi; k\in \mathbb Z \right \}$;
\item $(\cotg x)^\prime = -\frac{1}{\sin^2 x}, x \in \mathbb R \smallsetminus \left \{ k\pi; k \in \mathbb Z \right \}$;
