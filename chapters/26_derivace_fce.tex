...
\begin{definition}
Nechť existuje vlastní derivace funcke $f(x)$ pro všechna $x\in M, M\subset D(f).$
...
Přímka $n$, která prochází bodem $T$ a je kolmá k pčímce $t$, se nazývá \textbf{normála
