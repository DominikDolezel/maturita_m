...
\begin{figure}[ht!]
     ...
     \caption{Pravoúhlý trojúhelník s přeponou $AB$}
     \label{prav_t}
\end{figure}
...
\begin{pozn}
    ...
    $$k^2+l^2=1, \quad\quad \forall (k,l).$$
\end{pozn}

\begin{pozn}
    V obrázku \ref{prav_t} platí pro úhel $\alpha = \sphericalangle BAC\colon$
    \begin{enumerate}[$i.$]
...
\begin{veta}
  $\forall x \in \mathbb{R}\smallsetminus\bigcup\limits_{k\in \mathbb Z} \left \{ \frac{k\pi}{2} \right \} \colon$
  \begin{enumerate}[$i.$]
...
\begin{veta}
  $\forall x \in \mathbb{R}\smallsetminus\bigcup\limits_{k\in \mathbb Z} \left \{ \frac{k\pi}{2} \right \}\colon \tg x \cdot \cotg x = 1.$
\end{veta}
