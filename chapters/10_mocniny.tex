...
\begin{veta}
  Vlastnosti mocninných funkcí $y= x^n, n \in \mathbb N$:
  \begin{enumerate}[1.]
    ...
    \begin{enumerate}[$i.$]
      ...
      \item Je rostoucí v intervalu $\left<  0,+\infty \right)$, je klesající v intervalu $\left( -\infty,0 \right> $.
...
\begin{veta}
    Vlastnosti odmocninných funkcí $y= \sqrt[n]{x}, n \in \mathbb N, n > 1$:
    \begin{enumerate}[$i.$]
