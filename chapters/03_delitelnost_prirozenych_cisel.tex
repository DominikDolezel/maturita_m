...
\begin{proof}
  sporem: Pokud by jich bylo konečně mnoho, mohli bychom je spolu všechny vynásobit a získat tak nějaké přirozené číslo. Když k němu pak přičteme 1 nebude dělitelné žádným z předchozích prvočísel -- každé číslo větší než 1 je ale prvočíslo, nebo číslo složené, toto nové číslo tak bude prvočíslo -- spor s tím, že jsme vynásobili všechna prvočísla.
\end{proof}
