...
\begin{definition}
  Číslo $d\in \mathbb N$ je \textbf{největší společný dělitel} čísel $a,b \in \mathbb N,$ jestliže jsou splněny zároveň obě podmínky:
  \begin{enumerate}[$i.$]
    \item $d\, | \, a \land d \, | \, b$ a
...
\begin{algoritmus}[Euklidův algoritmus]\label{eukliduvalg}
...
\begin{reseni}\,
    \begin{enumerate}[$i.$]
        ...
        \begin{enumerate}[$a.$]
       	    \item $a=3k, k\in \mathbb Z $, pak $3\, | \, (a^3-a)$ triviálně; nebo
...
\begin{reseni}\,
\begin{enumerate}[$i.$]
	\item nepřímo: Dokazujeme obměnu $5 \, \centernot | \, n \implies 5 \, \centernot | \, n^2$, což je zřejmé.
	\item sporem: Předpokládejme, že výrok platí. Pak $n^2=5q, q \in \mathbb Z$. Protože je 5 prvočíslo a~$n$~je
    celé, musí i~$5^2 \, | \, n^2,$ jinak by odmocnina byla iracionální. Pak tedy
...
\begin{reseni}
    ...
    \begin{enumerate}[1.]
        \item $n=1: 24 \, | \, (25+23) = 48$, platí
        \item Nechť $24 \, | \, V(n)$. Chceme dokázat, že $24 \, | \, V(n+1).$ Platí:
        \[
            V(n+1) = 25^{n+1}+ 23 = 25\cdot (25^n+23)-25\cdot 23+23=25V(n)-23(25-1),
        \]
        odkud vidíme, že $24\, | \, V(n+1),$ což jsme chtěli dokázat.
    \end{enumerate}
\end{reseni}
