...
\begin{definition}
  ...
  \begin{enumerate}[$i.$]
    \item \textbf{ostré maximum} na množině $M$, pokud $\forall x \in M\smallsetminus \left \{ a \right \}  \colon f(x) < f(a)$,
    \item \textbf{maximum} (neostré) na množině $M$, pokud $\forall x \in M \smallsetminus \left \{ a \right \}\colon f(x) \leq f(a)$,
    \item \textbf{ostré minimum} na množině $M$, pokud $\forall x \in M\smallsetminus \left \{ a \right \}\colon f(x) > f(a)$,
    \item \textbf{minimum} (neostré) na množině $M$, pokud $\forall x \in M\smallsetminus \left \{ a \right \} \colon f(x) \geq f(a)$.
  \end{enumerate}
\end{definition}
