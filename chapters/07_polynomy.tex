...
\begin{algoritmus}[Euklidův algoritmus pro polynomy]
  Obdobně jako u celých čísel v algoritmu \ref{eukliduvalg} i u polynomů lze pro hledání největšího společného dělitele využít Euklidův algoritmus.\\
