...
\begin{definition}
  ...
  \[
    (x-c)^k \mid P(x) \land (x-c)^{k+1} \,\centernot |\,  P(x).
  \]
\end{definition}
...
\begin{veta}
    ...
    Pak platí: $r \mid a_0 \land s \, |\, a_n.$
\end{veta}
...
\begin{veta}\label{odecitanivpolynomu}
    ...
    Pak platí:
    $$\forall m \in \mathbb Z\colon (r-ms) \, |\, a(m),$$
    kde $a(m)$ je hodnota polynomu $a(x)$ pro $x=m.$ Nejčastěji používáme $(r + s) \mid a(-1)$ a $(r - s) \, |\, a(1).$
\end{veta}
