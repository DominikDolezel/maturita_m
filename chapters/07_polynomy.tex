...
\begin{algoritmus}
  \textbf{Hornerovo schéma} je metoda pro vyhodnocení funkční hodnoty polynomu $P(x) \in \mathbb R [x]$ v bodě $ x_0 \in \mathbb R$ (resp. ověření, zda je $x_0$ kořen $P(x)$). Vysvětlení na~příkladu:
  \begin{center}
