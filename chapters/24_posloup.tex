...
\begin{enumerate}[$i.$]\label{dkaritposl}
...
\end{enumerate}
\item Užitím již dokázeného vztahu \ref{dkaritposl}:
\begin{align*}
    a_s &= a_1 + (s-1)d,\\
    a_r &= a_1 + (r-1)d.
\end{align*}
...
\begin{proof} Dokazujeme postupně.
\begin{enumerate}[$i.$]\label{dkgeomposl}
\item Matematickou indukcí:
\begin{enumerate}[1.]
...
\end{enumerate}
\item Užitím již dokázeného vztahu \ref{dkgeomposl}:
\begin{align*}
    a_s &= a_1\cdot q^{s-1},\\
    a_r &= a_1\cdot q^{r-1}.
\end{align*}
