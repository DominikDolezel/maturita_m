...
\begin{enumerate}[$i.$]
\item \textbf{rostoucí} právě tehdy, když $\forall n \in \mathbb N\colon a_n< a_{n+1},$
\item \textbf{klesající} právě tehdy, když $\forall n \in \mathbb N\colon a_n> a_{n+1},$
\item \textbf{nerostoucí} právě tehdy, když $\forall n \in \mathbb N\colon a_n\geq a_{n+1},$
\item \textbf{neklesající} právě tehdy, když $\forall n \in \mathbb N\colon a_n\leq a_{n+1}.$
\end{enumerate}
...
\begin{definition}
    Nechť $\left \{ a_n \right \}_{n=1}^\infty $ je posloupnost reálných čísel. Pak je
    \begin{enumerate}[$i.$]
    \item \textbf{prostá} právě tehdy, když $\forall m,n\in \mathbb N\colon m\ne n \implies a_m\ne a_n,$
   	\item \textbf{stacionární} (konstantní) právě tehdy, když $\forall n \in \mathbb N\colon a_n = a_{n+1}.$
    \end{enumerate}
\end{definition}
