...
\begin{definition}\,
\begin{enumerate}[$i.$]
  \item Nechť $b \in \mathbb R$. Funkci $f\colon y = b$ nazveme \textbf{konstantní funkcí}.
  \item Nechť $a, b \in \mathbb R, a \neq 0$. Funkci $f\colon y= ax + b$ nazveme \textbf{lineární funkcí}.
\end{enumerate}
\end{definition}
...
\begin{proof}\,
  \begin{enumerate}[$i.$]
    \item $b=0 \implies f\colon y= ax = f(x) \land -ax = -f(x) \implies f$ je lichá,\\
          $b\neq 0 \implies f\colon y = ax + b = f(x) = -ax + b \implies f$ není ani sudá, ani lichá;
