...
\begin{enumerate}[$i.$]
  \item Funkci $f\colon y = b$ nazveme \textbf{konstantní funkcí}.
  \item Funkci $f\colon y= ax + b$ nazveme \textbf{lineární funkcí}.
\end{enumerate}
\end{definition}
...
\begin{pozn}
Vlastnosti konstantní a lineární funkce:
  \begin{itemize}
...
\begin{proof}
Dokazujeme z definice nebo z grafu.
  \begin{enumerate}[$i.$]
    \item $b=0 \implies f\colon y= ax = f(x) \land -ax = -f(x) \implies f$ je lichá,\\
          $b\neq 0 \implies f\colon y = ax + b = f(x)$, ale $-f(x)\neq -ax - b$ a také $-f(x) \neq ax + b \implies f$ není ani sudá, ani lichá;
...
\begin{definition}
  Nechť $a,b,c \in \mathbb R, a \neq 0$. Pak funkci $f\colon y = ax^2 + bx+ c$ nazýváme \textbf{kvadratickou funkcí}.
\end{definition}
...
\begin{veta}
  Nechť $f\colon y = ax^2, a \neq 0$ je kvadratická funkce. Pak platí
  \begin{center}
    \begin{tabularx}{\textwidth}{ l | l  l }
        \, & $a>0$ & $a<0$ \\
        \hline
        obor hodnot & $\mathcal H(f) = \mathbb R^{+}_0$ & $\mathcal H(f) = \mathbb R^{-}_0$ \\
        parita & sudá & sudá \\
        monotónnost & $x \in \left(-\infty, 0\right>$ -- klesající & $x \in \left(-\infty, 0\right>$ -- rostoucí \\
        \, & $x \in \left<  0, \infty \right)$ -- rostoucí & $x \in \left<  0, \infty \right)$ -- klesající \\
...
\begin{proof}
    ...
    \begin{enumerate}
        \item[$i.$] parita: $\mathcal D(f) = \mathbb R$ -- platí, $f(-x)=a(-x)^2=ax^2=f(x) \implies f$ je sudá
...
\begin{veta}
  Nechť $f\colon y = ax^2+bx+c, a \neq 0$ je kvadratická funkce. Pak platí
  \begin{center}
    \begin{tabularx}{\textwidth}{ l | l  l }
        \, & $a>0$ & $a<0$ \\
        \hline
        obor hodnot & $\mathcal H(f) = \left< c-\frac{b^2}{4a}, \infty \right)$ & $\mathcal H(f) = \left (-\infty, c-\frac{b^2}{4a}\right>$ \\
        parita & \multicolumn{2}{ c }{obecně není ani sudá, ani lichá} \\
...
\begin{definition}
    Nechť $P(x)\in \mathbb R[x]$ je polynom. Pak funkci $f\colon y=P(x)$ nazveme \textbf{polynomickou funkcí}.
\end{definition}
...
\begin{definition}
    Nechť $y=f(x)$ je polynomická funkce. Pak $c\in \mathbb R$ nazveme \textbf{nulovým bodem} polynomické funkce $f$, pokud $f(c)=0.$
\end{definition}
