...
\begin{pozn}
    ...
    $$\forall M \in \mathbb R\, \exists \delta \in \mathbb R^+\, \forall x \in \left ( x_0-\delta,x_0+\delta \right )\smallsetminus\left \{ x_0 \right \}\colon f(x) > M \quad (\textrm{resp. } f(x) < M).$$
\end{pozn}
...
$$
\forall \varepsilon \in \mathbb R^+\,
    \exists K \in \mathbb R\, \forall x \in \mathbb R, x > K \quad (\textrm{resp. } x< K)\colon
    f(x) \in \left ( A-\varepsilon, A+\varepsilon \right ).
$$
\end{pozn}
