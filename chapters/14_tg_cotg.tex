...
\begin{definition}
  Funkce \textbf{arkustangens}, označená $f^{-1}\colon y=\arctg x$, se nazývá funkce inverzní k funkci $f\colon y=\tg x$, kde $\mathcal D(f)=\left ( -\frac{\pi}{2}, \frac{\pi}{2} \right )$.
\end{definition}
...
\begin{definition}
  Funkce \textbf{arkuskotangens}, označená $g^{-1}\colon y=\arccotg x$, se nazývá funkce inverzní k funkci $g\colon y=\cotg x$, kde $\mathcal D(g)=\left ( 0, \pi \right )$.
\end{definition}
