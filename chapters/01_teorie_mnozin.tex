...
\begin{definition}
  \textbf{Množina} je souhrn objektů, chápaný jako celek. Tyto objekty nazýváme \textbf{prvky} množiny.
\end{definition}
...
\begin{proof} Důkaz provedeme rozkreslením stran rovnosti pomocí Vennových diagramů.
  \begin{figure}[ht!]
    \centering
    \tikzfig{venn_dukaz}
    \caption{Důkaz De Morganových pravidel}
  \end{figure}
  \qedhere
\end{proof}
...
\begin{definition}
  \textbf{Racionálním číslem} nazveme takové číslo $a = k/l$, kde $ k \in \mathbb{Z}$, $l \in \mathbb{N}$ a $k,l$ jsou nesoudělná.
\end{definition}
