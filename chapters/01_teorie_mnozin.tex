...
\begin{proof}
  ...
  \begin{minipage}{0.5\textwidth}
        \includegraphics[width=\linewidth]{vennsjed.png}
        \includegraphics[width=\linewidth]{venndoplsjed.png}
  \end{minipage}
  \hfill
  \noindent\begin{minipage}{0.5\textwidth}
        \includegraphics[width=\linewidth]{venndoplAaB.png}
        \includegraphics[width=\linewidth]{venndoplsjed.png}
  \end{minipage}
...
\begin{definition}
  Množina komplexních čísel C je množina uspořádaných reálných dvojic $[x, y]$, na kterých je definována rovnost, sčítání a násobení následovně:
...
\begin{example}[SMP 140/6abc]
  ...
  \end{enumerate}
  Řešení viz papír nemám kapacitu na to v 2103 vymýšlet množiny v latexu
\end{example}
