...
\begin{veta}
    Integrály tvaru
    $$\int R(x,\sqrt[s]{x}) \, \d x, \,\,\, \textrm{kde } s \in \mathbb N, s \geq 2$$
    řešíme substitucí $x=t^s$.
\end{veta}

\begin{veta}
    Integrály tvaru
    $$\int S(x, \sqrt[s_1]{x}, \dots, \sqrt[s_k]{x}  ) \, \d x ,\,\,\, \textrm{kde } k \in \mathbb N, s_i \geq 2$$
    řešíme substitucí $x=t^s,$ kde $s$ je nejmenší společný násobek $s_1,\dots, s_k.$
\end{veta}

\begin{veta}
    Integrály tvaru
    $$\int R(x, \sqrt[s]{ax+b} )\, \d x, \,\,\, \textrm{kde } s \in \mathbb N, s \geq 2, a,b \in \mathbb R$$
    řešíme substitucí $t^s=ax+b$.
\end{veta}

\begin{veta}
    Integrály tvaru
    $$\int R\left (x, \sqrt[s]{\frac{ax+b}{cx+d}} \right)\, \d x, \,\,\, \textrm{kde } s \in \mathbb N, s \geq 2, a,b,c,d \in \mathbb R, ad-bc \ne 0$$
    řešíme substitucí $t^s=\frac{ax+b}{cx+d}.$
\end{veta}

\begin{veta}[Eulerovy substituce]
    Integrály tvaru
    $$\int R(x,\sqrt{ax^2+bx+c}) \, \d x, \,\,\, \textrm{kde } a,b,c\in \mathbb R, a \ne 0$$
    řešíme substitucemi
    \begin{align*}
