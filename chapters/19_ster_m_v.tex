...
\begin{veta}
  Označme $V$ objem tělesa, $S$ jeho povrch, dále obsahy $S_{\text{pláště}}$, $S_{\text{podstavy}}$, $\mathbf{a},\mathbf{b},\mathbf{c}$ vektory stran, $a$, $b$, $c$ jejich délky. Pak se rovnají:
  \begin{center}
    \begin{tabularx}{\textwidth}{ l | l  l  l }
      ...
      rovnoběžnostěn & $| ( \mathbf{a} \times \mathbf{b} ) \cdot \mathbf{c} | = | ( \mathbf{b} \times \mathbf{c} ) \cdot \mathbf{a} | = | ( \mathbf{c} \times \mathbf{a} ) \cdot \mathbf{b} |$ & $2[((\mathbf{a} \times \mathbf{b}) \cdot (\mathbf{a} \times \mathbf{b}))^{1/2}+ ((\mathbf{b} \times \mathbf{c}) \cdot (\mathbf{b} \times \mathbf{c}))^{1/2}+ ((\mathbf{c} \times \mathbf{a}) \cdot (\mathbf{c} \times \mathbf{a}))^{1/2}]$ & \, \\
      kvádr & $abc$ & $2(ab+bc+ca)$ & \, \\
      krychle & $a^3$ & $6a$ & \, \\
      válec & $S_{podstavy}\cdot v$ & $2S_{podstavy} + S_{pláště}$ & $o_{podstavy} \cdot v$ \\
      jehlan & $\frac{1}{3}\cdot S_{podstavy}\cdot v$ & \, & \, \\
