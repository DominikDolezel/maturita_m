...
\begin{veta}
    Nechť jsou dány přímky $p^\prime, q^\prime; p,q \subset \mathbb E_3$ takové, že $p\parallel p^\prime$ a $q\parallel q^\prime.$ Pak platí, že $|\sphericalangle p^\prime q^\prime|=|\sphericalangle p q|.$
\end{veta}
