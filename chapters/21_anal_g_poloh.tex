...
si napišme  tyto vektory do matice a upravujme ji do schodovitého tvaru. Je
$$
\begin{pmatrix}
	1 & 2 & 2 \\
	1 & 0 & 1 \\
...
\begin{reseni}
Přímka $p$ má směrový vektor $\vec u = (1,2,-1)$ a rovina $\rho$ má směrové vektory $\vec v=(-3,2,4)$ a
...
\end{pmatrix},
$$
odkud vidíme, že dimenze je 3, a proto jsou $p$ a $\rho$ různoběžné.
\end{reseni}
...
\begin{reseni}
Přímka $p$ má směrový vektor $\vec u= (-1,3,-3)$ a rovina $\rho$ má normálový vektor $\vec n=(3,1,5)$.
Spočteme skalární součin
$$
    \vec u \cdot \vec n = -3+3-15 = -15,
$$
a tedy $p$ a $\rho$ jsou různoběžné.
\end{reseni}
